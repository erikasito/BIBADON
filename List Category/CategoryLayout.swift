...
class CategoryController: UICollectionViewController {
    ...
    init() {
        super.init(collectionViewLayout: CategoryController.createLayout())
    }
...
//                item.contentInsets.bottom = 16
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = "BIBADON"
        
        collectionView.register(UICollectionViewCell.self, forCellWithReuseIdentifier: cellId)
        collectionView.register(Header.self, forSupplementaryViewOfKind: CategoryController.categoryHeaderId, withReuseIdentifier: headerId)
    }
